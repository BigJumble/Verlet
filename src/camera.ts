class Camera {
    ...
    static game: HTMLElement;
    static mainView: SVGSVGElement;
    static viewbox: DOMRect;
    ...
    static init() {
        ...
        this.game = screenObj.root as HTMLElement;
        this.mainView = screenObj.elementsWithId.mainView as SVGSVGElement;

        GameManager.layerGround = screenObj.elementsWithId.layerGround as SVGGElement;
        GameManager.layerMain = screenObj.elementsWithId.layerMain as SVGGElement;
        GameManager.layerEffects = screenObj.elementsWithId.layerEffects as SVGGElement;
